...
namespace GodotEngine
{
    ...
    public class Area : CollisionObject
    {
        ...
        {
            NativeCalls.godot_icall_1_83(method_bind_6, Object.GetPtr(this), ref vector);
        }
        ...
        {
            NativeCalls.godot_icall_1_10(method_bind_10, Object.GetPtr(this), angular_damp);
        }
        ...
        {
            NativeCalls.godot_icall_1_10(method_bind_12, Object.GetPtr(this), linear_damp);
        }
        ...
        private IntPtr method_bind_26 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_monitoring");
        ...
        private IntPtr method_bind_27 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "is_monitoring");
        ...
        private IntPtr method_bind_32 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_audio_bus_override");
        ...
        private IntPtr method_bind_33 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "is_overriding_audio_bus");
        ...
        private IntPtr method_bind_34 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_audio_bus");

        public void set_audio_bus(string name)
        {
            NativeCalls.godot_icall_1_34(method_bind_34, Object.GetPtr(this), name);
        }

        private IntPtr method_bind_35 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_audio_bus");

        public string get_audio_bus()
        {
            return NativeCalls.godot_icall_0_2(method_bind_35, Object.GetPtr(this));
        }

        private IntPtr method_bind_36 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_use_reverb_bus");
        ...
        private IntPtr method_bind_37 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "is_using_reverb_bus");
        ...
        private IntPtr method_bind_38 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_reverb_bus");

        public void set_reverb_bus(string name)
        {
            NativeCalls.godot_icall_1_34(method_bind_38, Object.GetPtr(this), name);
        }

        private IntPtr method_bind_39 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_reverb_bus");

        public string get_reverb_bus()
        {
            return NativeCalls.godot_icall_0_2(method_bind_39, Object.GetPtr(this));
        }

        private IntPtr method_bind_40 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_reverb_amount");

        public void set_reverb_amount(float amount)
        {
            NativeCalls.godot_icall_1_10(method_bind_40, Object.GetPtr(this), amount);
        }

        private IntPtr method_bind_41 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_reverb_amount");

        public float get_reverb_amount()
        {
            return NativeCalls.godot_icall_0_11(method_bind_41, Object.GetPtr(this));
        }

        private IntPtr method_bind_42 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_reverb_uniformity");

        public void set_reverb_uniformity(float amount)
        {
            NativeCalls.godot_icall_1_10(method_bind_42, Object.GetPtr(this), amount);
        }

        private IntPtr method_bind_43 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_reverb_uniformity");

        public float get_reverb_uniformity()
        {
