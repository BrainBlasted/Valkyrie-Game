...
namespace GodotEngine
{
    public class VisualScriptYieldSignal : VisualScriptNode
    {
        ...
        public VisualScriptYieldSignal() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            NativeCalls.godot_icall_1_35(method_bind_2, Object.GetPtr(this), signal);
        }
        ...
        {
            NativeCalls.godot_icall_1_65(method_bind_6, Object.GetPtr(this), NodePath.GetPtr(base_path));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_0_66(method_bind_7, Object.GetPtr(this));
