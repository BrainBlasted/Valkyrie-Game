...
namespace GodotEngine
{
    ...
    public class Camera : Spatial
    {
        ...
        private IntPtr method_bind_21 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_cull_mask");

        public void set_cull_mask(int mask)
        {
            NativeCalls.godot_icall_1_0(method_bind_21, Object.GetPtr(this), mask);
        }

        private IntPtr method_bind_22 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_cull_mask");
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_25, Object.GetPtr(this), mode);
        }
        ...
        private IntPtr method_bind_27 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_doppler_tracking");

        public void set_doppler_tracking(int mode)
        {
            NativeCalls.godot_icall_1_0(method_bind_27, Object.GetPtr(this), mode);
        }

        private IntPtr method_bind_28 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_doppler_tracking");
