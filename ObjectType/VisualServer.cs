...
namespace GodotEngine
{
    ...
    public static class VisualServer
    {
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_0_122(method_bind_0, ptr);
            return new RID(ret);
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_515(method_bind_1, ptr, Object.GetPtr(image), flags);
            return new RID(ret);
        }

        private static IntPtr method_bind_2 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "texture_set_flags");

        public static void texture_set_flags(RID texture, int flags)
        {
            NativeCalls.godot_icall_2_352(method_bind_2, ptr, RID.GetPtr(texture), flags);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_3, ptr, RID.GetPtr(texture));
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_4, ptr, RID.GetPtr(texture));
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_5, ptr, RID.GetPtr(texture));
        }
