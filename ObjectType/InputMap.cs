...
namespace GodotEngine
{
    public static class InputMap
    {
        ...
        {
            return NativeCalls.godot_icall_1_56(method_bind_0, ptr, action);
        }
        ...
        {
            return NativeCalls.godot_icall_0_84(method_bind_1, ptr);
        }
        ...
        {
            NativeCalls.godot_icall_1_34(method_bind_2, ptr, action);
        }
        ...
        {
            NativeCalls.godot_icall_1_34(method_bind_3, ptr, action);
        }
        ...
        {
            NativeCalls.godot_icall_2_72(method_bind_4, ptr, action, Object.GetPtr(@event));
        }
        ...
        {
            NativeCalls.godot_icall_2_72(method_bind_6, ptr, action, Object.GetPtr(@event));
        }
