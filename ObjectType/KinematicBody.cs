...
namespace GodotEngine
{
    ...
    public class KinematicBody : PhysicsBody
    {
        ...
        /// </summary>
        public Dictionary<object, object> move(Vector3 rel_vec)
        {
            return NativeCalls.godot_icall_1_267(method_bind_0, Object.GetPtr(this), ref rel_vec);
        }

        private IntPtr method_bind_1 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "move_and_slide");

        public Vector3 move_and_slide(Vector3 linear_velocity, Nullable<Vector3> floor_normal = null, float slope_stop_min_velocity = 0.05f, int max_bounces = 4, float floor_max_angle = 0.785398f)
        {
            Vector3 floor_normal_in = floor_normal.HasValue ? floor_normal.Value : new Vector3(0, 0, 0);
            object ret = NativeCalls.godot_icall_5_268(method_bind_1, Object.GetPtr(this), ref linear_velocity, ref floor_normal_in, slope_stop_min_velocity, max_bounces, floor_max_angle);
            return (Vector3)ret;
        }

        private IntPtr method_bind_2 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "test_move");

        public bool test_move(Transform from, Vector3 rel_vec)
        {
            return NativeCalls.godot_icall_2_269(method_bind_2, Object.GetPtr(this), ref from, ref rel_vec);
        }
        ...
        public Vector3 get_floor_velocity()
        {
        ...
        public Vector3 get_collision_position(int collision)
        {
            object ret = NativeCalls.godot_icall_1_21(method_bind_10, Object.GetPtr(this), collision);
            return (Vector3)ret;
        }

        private IntPtr method_bind_11 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_collision_normal");

        public Vector3 get_collision_normal(int collision)
        {
            object ret = NativeCalls.godot_icall_1_21(method_bind_11, Object.GetPtr(this), collision);
            return (Vector3)ret;
        }

        private IntPtr method_bind_12 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_collision_travel");

        public Vector3 get_collision_travel(int collision)
        {
            object ret = NativeCalls.godot_icall_1_21(method_bind_12, Object.GetPtr(this), collision);
            return (Vector3)ret;
        }

        private IntPtr method_bind_13 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_collision_remainder");

        public Vector3 get_collision_remainder(int collision)
        {
            object ret = NativeCalls.godot_icall_1_21(method_bind_13, Object.GetPtr(this), collision);
            return (Vector3)ret;
        }
        ...
        {
            return NativeCalls.godot_icall_1_148(method_bind_14, Object.GetPtr(this), collision);
        }
        ...
        {
            return NativeCalls.godot_icall_1_148(method_bind_15, Object.GetPtr(this), collision);
        }
        ...
        {
            return NativeCalls.godot_icall_1_148(method_bind_17, Object.GetPtr(this), collision);
        }
        ...
        public Vector3 get_collision_collider_velocity(int collision)
        {
            object ret = NativeCalls.godot_icall_1_21(method_bind_19, Object.GetPtr(this), collision);
            return (Vector3)ret;
        }

        private IntPtr method_bind_20 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_collision_collider_metadata");

        public void get_collision_collider_metadata(int collision)
        {
            NativeCalls.godot_icall_1_0(method_bind_20, Object.GetPtr(this), collision);
        }
    }
}
