...
namespace GodotEngine
{
    public static class Marshalls
    {
        ...
        {
            return NativeCalls.godot_icall_1_409(method_bind_0, ptr, variant);
        }
        ...
        {
            return NativeCalls.godot_icall_1_319(method_bind_1, ptr, base64_str);
        }
        ...
        {
            return NativeCalls.godot_icall_1_545(method_bind_2, ptr, array);
        }
        ...
        {
            return NativeCalls.godot_icall_1_546(method_bind_3, ptr, base64_str);
        }
        ...
        {
            return NativeCalls.godot_icall_1_60(method_bind_4, ptr, utf8_str);
        }
        ...
        {
            return NativeCalls.godot_icall_1_60(method_bind_5, ptr, base64_str);
        }
    }
}
