...
namespace GodotEngine
{
    ...
    public class Font : Resource
    {
        ...
        public void draw(RID canvas_item, Vector2 pos, string @string, Nullable<Color> modulate = null, int clip_w = -1)
        {
            ...
            NativeCalls.godot_icall_5_199(method_bind_0, Object.GetPtr(this), RID.GetPtr(canvas_item), ref pos, @string, ref modulate_in, clip_w);
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            return NativeCalls.godot_icall_5_200(method_bind_6, Object.GetPtr(this), RID.GetPtr(canvas_item), ref pos, @char, next, ref modulate_in);
        }
