...
namespace GodotEngine
{
    public static class Geometry
    {
        ...
        {
            return NativeCalls.godot_icall_1_534(method_bind_0, ptr, ref extents);
        }
        ...
        {
            return NativeCalls.godot_icall_4_535(method_bind_1, ptr, radius, height, sides, axis);
        }
        ...
        {
            return NativeCalls.godot_icall_5_536(method_bind_2, ptr, radius, height, sides, lats, axis);
        }
        ...
        {
            return NativeCalls.godot_icall_4_537(method_bind_3, ptr, ref segment_from, ref segment_to, ref circle_pos, circle_radius);
        }
        ...
        {
            NativeCalls.godot_icall_4_538(method_bind_4, ptr, ref from_a, ref to_a, ref from_b, ref to_b);
        }
        ...
        {
            return NativeCalls.godot_icall_4_539(method_bind_5, ptr, ref p1, ref q1, ref p2, ref q2);
        }
        ...
        {
            return NativeCalls.godot_icall_4_540(method_bind_6, ptr, ref p1, ref p2, ref q1, ref q2);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_3_541(method_bind_7, ptr, ref point, ref s1, ref s2);
            return (Vector2)ret;
        }
        ...
        {
            object ret = NativeCalls.godot_icall_3_542(method_bind_8, ptr, ref point, ref s1, ref s2);
            return (Vector3)ret;
        }
        ...
        {
            object ret = NativeCalls.godot_icall_3_541(method_bind_9, ptr, ref point, ref s1, ref s2);
            return (Vector2)ret;
        }
        ...
        {
            object ret = NativeCalls.godot_icall_3_542(method_bind_10, ptr, ref point, ref s1, ref s2);
            return (Vector3)ret;
        }
        ...
        {
            NativeCalls.godot_icall_5_543(method_bind_12, ptr, ref from, ref dir, ref a, ref b, ref c);
        }
        ...
        {
            NativeCalls.godot_icall_5_543(method_bind_13, ptr, ref from, ref to, ref a, ref b, ref c);
        }
        ...
        {
            return NativeCalls.godot_icall_4_544(method_bind_14, ptr, ref from, ref to, ref spos, sradius);
        }
        ...
        {
            return NativeCalls.godot_icall_4_545(method_bind_15, ptr, ref from, ref to, height, radius);
        }
        ...
        {
            return NativeCalls.godot_icall_3_546(method_bind_16, ptr, ref from, ref to, planes);
        }
        ...
        {
            return NativeCalls.godot_icall_4_547(method_bind_17, ptr, ref point, ref a, ref b, ref c);
        }
        ...
        {
            return NativeCalls.godot_icall_1_548(method_bind_18, ptr, polygon);
        }
        ...
        {
            return NativeCalls.godot_icall_1_549(method_bind_19, ptr, sizes);
        }
    }
}
