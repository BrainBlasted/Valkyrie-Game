...
namespace GodotEngine
{
    ...
    public class NetworkedMultiplayerENet : NetworkedMultiplayerPeer
    {
        ...
        public const int COMPRESS_ZSTD = 4;

        private const string nativeName = "NetworkedMultiplayerENet";

        public NetworkedMultiplayerENet() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            return NativeCalls.godot_icall_4_302(method_bind_0, Object.GetPtr(this), port, max_clients, in_bandwidth, out_bandwidth);
        }
        ...
        {
            return NativeCalls.godot_icall_4_303(method_bind_1, Object.GetPtr(this), ip, port, in_bandwidth, out_bandwidth);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_3, Object.GetPtr(this), mode);
        }
        ...
        {
            NativeCalls.godot_icall_1_35(method_bind_5, Object.GetPtr(this), ip);
        }
    }
}
