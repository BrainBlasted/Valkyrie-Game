...
namespace GodotEngine
{
    public class PhysicsDirectSpaceState : Object
    {
        ...
        public Dictionary<object, object> intersect_ray(Vector3 from, Vector3 to, object[] exclude = null, int collision_layer = 2147483647, int type_mask = 15)
        {
            ...
            return NativeCalls.godot_icall_5_380(method_bind_0, Object.GetPtr(this), ref from, ref to, exclude_in, collision_layer, type_mask);
        }
        ...
        {
            return NativeCalls.godot_icall_2_345(method_bind_1, Object.GetPtr(this), Object.GetPtr(shape), max_results);
        }
        ...
        {
            return NativeCalls.godot_icall_2_381(method_bind_2, Object.GetPtr(this), Object.GetPtr(shape), ref motion);
        }
        ...
        {
            return NativeCalls.godot_icall_2_345(method_bind_3, Object.GetPtr(this), Object.GetPtr(shape), max_results);
        }
        ...
        {
            return NativeCalls.godot_icall_1_347(method_bind_4, Object.GetPtr(this), Object.GetPtr(shape));
        }
    }
}
