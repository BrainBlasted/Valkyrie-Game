...
namespace GodotEngine
{
    public class VisualScriptFunctionCall : VisualScriptNode
    {
        ...
        public VisualScriptFunctionCall() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_14, Object.GetPtr(this), amount);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_16, Object.GetPtr(this), mode);
        }
