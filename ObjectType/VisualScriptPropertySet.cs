...
namespace GodotEngine
{
    public class VisualScriptPropertySet : VisualScriptNode
    {
        ...
        public VisualScriptPropertySet() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            NativeCalls.godot_icall_1_34(method_bind_6, Object.GetPtr(this), property);
        }
        ...
        {
            NativeCalls.godot_icall_1_64(method_bind_10, Object.GetPtr(this), NodePath.GetPtr(base_path));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_0_65(method_bind_11, Object.GetPtr(this));
        ...
        {
            NativeCalls.godot_icall_1_34(method_bind_12, Object.GetPtr(this), index);
        }
        ...
        private IntPtr method_bind_14 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_assign_op");

        public void set_assign_op(int assign_op)
        {
            NativeCalls.godot_icall_1_0(method_bind_14, Object.GetPtr(this), assign_op);
        }

        private IntPtr method_bind_15 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_assign_op");

        public int get_assign_op()
        {
