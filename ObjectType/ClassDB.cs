...
namespace GodotEngine
{
    public static class ClassDB
    {
        ...
        {
            return NativeCalls.godot_icall_0_59(method_bind_0, ptr);
        }
        ...
        {
            return NativeCalls.godot_icall_1_164(method_bind_1, ptr, @class);
        }
        ...
        {
            return NativeCalls.godot_icall_1_60(method_bind_2, ptr, @class);
        }
        ...
        {
            return NativeCalls.godot_icall_1_57(method_bind_3, ptr, @class);
        }
        ...
        {
            return NativeCalls.godot_icall_2_163(method_bind_4, ptr, @class, inherits);
        }
        ...
        {
            return NativeCalls.godot_icall_1_57(method_bind_5, ptr, @class);
        }
        ...
        {
            return NativeCalls.godot_icall_1_319(method_bind_6, ptr, @class);
        }
        ...
        {
            return NativeCalls.godot_icall_2_163(method_bind_7, ptr, @class, signal);
        }
        ...
        {
            return NativeCalls.godot_icall_2_517(method_bind_8, ptr, @class, signal);
        }
        ...
        {
            return NativeCalls.godot_icall_2_518(method_bind_9, ptr, @class, no_inheritance);
        }
        ...
        {
            return NativeCalls.godot_icall_2_518(method_bind_10, ptr, @class, no_inheritance);
        }
        ...
        {
            return NativeCalls.godot_icall_2_519(method_bind_11, ptr, Object.GetPtr(@object), property);
        }

        private static IntPtr method_bind_12 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "class_set_property");

        public static int class_set_property(Object @object, string property, object value)
        {
            return NativeCalls.godot_icall_3_520(method_bind_12, ptr, Object.GetPtr(@object), property, value);
        }
        ...
        {
            return NativeCalls.godot_icall_3_521(method_bind_13, ptr, @class, method, no_inheritance);
        }
        ...
        {
            return NativeCalls.godot_icall_2_518(method_bind_14, ptr, @class, no_inheritance);
        }
        ...
        {
            return NativeCalls.godot_icall_2_522(method_bind_15, ptr, @class, no_inheritance);
        }
        ...
        {
            return NativeCalls.godot_icall_2_163(method_bind_16, ptr, @class, name);
        }
        ...
        {
            return NativeCalls.godot_icall_2_70(method_bind_17, ptr, @class, name);
        }
        ...
        {
            return NativeCalls.godot_icall_1_60(method_bind_18, ptr, @class);
        }
        ...
        {
            return NativeCalls.godot_icall_1_57(method_bind_19, ptr, @class);
        }
    }
}
