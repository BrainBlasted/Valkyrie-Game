...
namespace GodotEngine
{
    ...
    public static class Physics2DServer
    {
        ...
        public const int SPACE_PARAM_BODY_LINEAR_VELOCITY_SLEEP_THRESHOLD = 3;
        public const int SPACE_PARAM_BODY_ANGULAR_VELOCITY_SLEEP_THRESHOLD = 4;
        /// <summary>
        ...
        {
            return NativeCalls.godot_icall_1_349(method_bind_9, ptr, RID.GetPtr(space));
        }
        ...
        public static void area_add_shape(RID area, RID shape, Nullable<Transform2D> transform = null)
        {
            ...
            NativeCalls.godot_icall_3_353(method_bind_15, ptr, RID.GetPtr(area), RID.GetPtr(shape), ref transform_in);
        }
        ...
        {
            NativeCalls.godot_icall_3_355(method_bind_17, ptr, RID.GetPtr(area), shape_idx, ref transform);
        }
        ...
        {
            NativeCalls.godot_icall_3_356(method_bind_18, ptr, RID.GetPtr(area), shape_idx, disable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_19, ptr, RID.GetPtr(area));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_357(method_bind_20, ptr, RID.GetPtr(area), shape_idx);
            return new RID(ret);
        }

        private static IntPtr method_bind_21 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "area_get_shape_transform");
        ...
        {
            object ret = NativeCalls.godot_icall_2_358(method_bind_21, ptr, RID.GetPtr(area), shape_idx);
            return (Transform2D)ret;
        }

        private static IntPtr method_bind_22 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "area_remove_shape");
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_22, ptr, RID.GetPtr(area), shape_idx);
        }
        ...
        {
            NativeCalls.godot_icall_1_359(method_bind_23, ptr, RID.GetPtr(area));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_24, ptr, RID.GetPtr(area), layer);
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_25, ptr, RID.GetPtr(area), mask);
        }
        ...
        {
            NativeCalls.godot_icall_3_360(method_bind_26, ptr, RID.GetPtr(area), param, value);
        }
        ...
        {
            NativeCalls.godot_icall_2_361(method_bind_27, ptr, RID.GetPtr(area), ref transform);
        }
        ...
        {
            return NativeCalls.godot_icall_2_362(method_bind_28, ptr, RID.GetPtr(area), param);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_363(method_bind_29, ptr, RID.GetPtr(area));
            return (Transform2D)ret;
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_30, ptr, RID.GetPtr(area), id);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_31, ptr, RID.GetPtr(area));
        }
        ...
        {
            NativeCalls.godot_icall_3_364(method_bind_32, ptr, RID.GetPtr(area), Object.GetPtr(receiver), method);
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_365(method_bind_33, ptr, mode, init_sleeping);
            return new RID(ret);
        }

        private static IntPtr method_bind_34 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_space");
        ...
        {
            NativeCalls.godot_icall_2_350(method_bind_34, ptr, RID.GetPtr(body), RID.GetPtr(space));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_1_351(method_bind_35, ptr, RID.GetPtr(body));
            return new RID(ret);
        }

        private static IntPtr method_bind_36 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_mode");
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_36, ptr, RID.GetPtr(body), mode);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_37, ptr, RID.GetPtr(body));
        }
        ...
        {
            Transform2D transform_in = transform.HasValue ? transform.Value : Transform2D.Identity;
            NativeCalls.godot_icall_3_353(method_bind_38, ptr, RID.GetPtr(body), RID.GetPtr(shape), ref transform_in);
        }
        ...
        {
            NativeCalls.godot_icall_3_354(method_bind_39, ptr, RID.GetPtr(body), shape_idx, RID.GetPtr(shape));
        }
        ...
        {
            NativeCalls.godot_icall_3_355(method_bind_40, ptr, RID.GetPtr(body), shape_idx, ref transform);
        }
        ...
        {
            NativeCalls.godot_icall_3_360(method_bind_41, ptr, RID.GetPtr(body), shape_idx, metadata);
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_357(method_bind_43, ptr, RID.GetPtr(body), shape_idx);
            return new RID(ret);
        }

        private static IntPtr method_bind_44 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_get_shape_transform");
        ...
        {
            object ret = NativeCalls.godot_icall_2_358(method_bind_44, ptr, RID.GetPtr(body), shape_idx);
            return (Transform2D)ret;
        }

        private static IntPtr method_bind_45 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_get_shape_metadata");

        /// <summary>
        /// Return the metadata of a shape of a body.
        /// </summary>
        public static object body_get_shape_metadata(RID body, int shape_idx)
        {
            return NativeCalls.godot_icall_2_362(method_bind_45, ptr, RID.GetPtr(body), shape_idx);
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_46, ptr, RID.GetPtr(body), shape_idx);
        }
        ...
        {
            NativeCalls.godot_icall_1_359(method_bind_47, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_3_356(method_bind_48, ptr, RID.GetPtr(body), shape_idx, disable);
        }
        ...
        {
            NativeCalls.godot_icall_3_356(method_bind_49, ptr, RID.GetPtr(body), shape_idx, enable);
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_50, ptr, RID.GetPtr(body), id);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_51, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_52, ptr, RID.GetPtr(body), mode);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_53, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_54, ptr, RID.GetPtr(body), layer);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_55, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_56, ptr, RID.GetPtr(body), mask);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_57, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_3_347(method_bind_58, ptr, RID.GetPtr(body), param, value);
        }
        ...
        {
            return NativeCalls.godot_icall_2_348(method_bind_59, ptr, RID.GetPtr(body), param);
        }
        ...
        {
            NativeCalls.godot_icall_3_360(method_bind_60, ptr, RID.GetPtr(body), state, value);
        }
        ...
        {
            return NativeCalls.godot_icall_2_362(method_bind_61, ptr, RID.GetPtr(body), state);
        }
        ...
        {
            NativeCalls.godot_icall_3_366(method_bind_62, ptr, RID.GetPtr(body), ref pos, ref impulse);
        }
        ...
        {
            NativeCalls.godot_icall_3_366(method_bind_63, ptr, RID.GetPtr(body), ref offset, ref force);
        }
        ...
        {
            NativeCalls.godot_icall_2_367(method_bind_64, ptr, RID.GetPtr(body), ref axis_velocity);
        }
        ...
        {
            NativeCalls.godot_icall_2_350(method_bind_66, ptr, RID.GetPtr(body), RID.GetPtr(excepted_body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_67, ptr, RID.GetPtr(body), amount);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_68, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_345(method_bind_69, ptr, RID.GetPtr(body), enable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_346(method_bind_70, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_4_368(method_bind_71, ptr, RID.GetPtr(body), Object.GetPtr(receiver), method, userdata);
        }
        ...
        {
            return NativeCalls.godot_icall_5_369(method_bind_72, ptr, RID.GetPtr(body), ref from, ref motion, margin, Object.GetPtr(result));
        }
        ...
        {
            NativeCalls.godot_icall_3_347(method_bind_73, ptr, RID.GetPtr(joint), param, value);
        }
        ...
        {
            return NativeCalls.godot_icall_2_348(method_bind_74, ptr, RID.GetPtr(joint), param);
        }
        ...
        public static RID pin_joint_create(Vector2 anchor, RID body_a, RID body_b = null)
        {
            ...
            IntPtr ret = NativeCalls.godot_icall_3_370(method_bind_75, ptr, ref anchor, RID.GetPtr(body_a), RID.GetPtr(body_b_in));
            return new RID(ret);
        }

        private static IntPtr method_bind_76 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "groove_joint_create");
        ...
        public static RID groove_joint_create(Vector2 groove1_a, Vector2 groove2_a, Vector2 anchor_b, RID body_a = null, RID body_b = null)
        {
            ...
            RID body_b_in = body_b != null ? body_b : new RID();
            IntPtr ret = NativeCalls.godot_icall_5_371(method_bind_76, ptr, ref groove1_a, ref groove2_a, ref anchor_b, RID.GetPtr(body_a_in), RID.GetPtr(body_b_in));
            return new RID(ret);
        }

        private static IntPtr method_bind_77 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "damped_spring_joint_create");
        ...
        {
            RID body_b_in = body_b != null ? body_b : new RID();
            IntPtr ret = NativeCalls.godot_icall_4_372(method_bind_77, ptr, ref anchor_a, ref anchor_b, RID.GetPtr(body_a), RID.GetPtr(body_b_in));
            return new RID(ret);
        }

        private static IntPtr method_bind_78 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "damped_string_joint_set_param");
        ...
        {
            NativeCalls.godot_icall_3_347(method_bind_78, ptr, RID.GetPtr(joint), param, value);
        }
        ...
        {
            return NativeCalls.godot_icall_2_348(method_bind_79, ptr, RID.GetPtr(joint), param);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_80, ptr, RID.GetPtr(joint));
        }
        ...
        {
            NativeCalls.godot_icall_1_359(method_bind_81, ptr, RID.GetPtr(rid));
        }
        ...
        {
            NativeCalls.godot_icall_1_7(method_bind_82, ptr, active);
        }

        private static IntPtr method_bind_83 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_process_info");
        ...
        {
            return NativeCalls.godot_icall_1_5(method_bind_83, ptr, process_info);
        }
    }
}
