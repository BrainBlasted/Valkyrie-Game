...
namespace GodotEngine
{
    ...
    public class StyleBoxFlat : StyleBox
    {
        ...
        public StyleBoxFlat() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_6, Object.GetPtr(this), size);
        }
        ...
        {
            NativeCalls.godot_icall_1_7(method_bind_8, Object.GetPtr(this), blend);
        }
        ...
        {
            NativeCalls.godot_icall_1_7(method_bind_10, Object.GetPtr(this), size);
        }
