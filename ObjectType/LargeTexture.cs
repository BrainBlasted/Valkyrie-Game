...
namespace GodotEngine
{
    ...
    public class LargeTexture : Texture
    {
        ...
        public LargeTexture() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            NativeCalls.godot_icall_2_181(method_bind_1, Object.GetPtr(this), idx, ref ofs);
        }
        ...
        {
            NativeCalls.godot_icall_1_37(method_bind_3, Object.GetPtr(this), ref size);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_178(method_bind_6, Object.GetPtr(this), idx);
            return (Vector2)ret;
        }
