...
namespace GodotEngine
{
    ...
    public class Light2D : Node2D
    {
        ...
        {
            NativeCalls.godot_icall_1_7(method_bind_2, Object.GetPtr(this), editor_only);
        }
        ...
        {
            NativeCalls.godot_icall_1_37(method_bind_6, Object.GetPtr(this), ref texture_offset);
        }
        ...
        {
            NativeCalls.godot_icall_1_10(method_bind_10, Object.GetPtr(this), height);
        }
        ...
        {
            NativeCalls.godot_icall_1_10(method_bind_12, Object.GetPtr(this), energy);
        }
        ...
        {
            NativeCalls.godot_icall_1_10(method_bind_14, Object.GetPtr(this), texture_scale);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_16, Object.GetPtr(this), z);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_18, Object.GetPtr(this), z);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_20, Object.GetPtr(this), layer);
        }
        ...
        private IntPtr method_bind_24 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_item_cull_mask");

        /// <summary>
        /// Set the item mask of the Light2D to 'item_mask' value.
        /// </summary>
        public void set_item_cull_mask(int item_cull_mask)
        {
            NativeCalls.godot_icall_1_0(method_bind_24, Object.GetPtr(this), item_cull_mask);
        }

        private IntPtr method_bind_25 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_item_cull_mask");

        public int get_item_cull_mask()
        {
            return NativeCalls.godot_icall_0_1(method_bind_25, Object.GetPtr(this));
        }

        private IntPtr method_bind_26 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_item_shadow_cull_mask");

        /// <summary>
        /// Set the item shadow mask to 'item_shadow_mask' value.
        /// </summary>
        public void set_item_shadow_cull_mask(int item_shadow_cull_mask)
        {
            NativeCalls.godot_icall_1_0(method_bind_26, Object.GetPtr(this), item_shadow_cull_mask);
        }

        private IntPtr method_bind_27 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_item_shadow_cull_mask");

        public int get_item_shadow_cull_mask()
        {
        ...
        {
            NativeCalls.godot_icall_1_7(method_bind_30, Object.GetPtr(this), enabled);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_32, Object.GetPtr(this), size);
        }
        ...
        private IntPtr method_bind_34 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_shadow_smooth");

        public void set_shadow_smooth(float smooth)
        {
            NativeCalls.godot_icall_1_10(method_bind_34, Object.GetPtr(this), smooth);
        }

        private IntPtr method_bind_35 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_shadow_smooth");

        public float get_shadow_smooth()
        {
            return NativeCalls.godot_icall_0_11(method_bind_35, Object.GetPtr(this));
        }

        private IntPtr method_bind_36 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_shadow_gradient_length");

        public void set_shadow_gradient_length(float multiplier)
        {
            NativeCalls.godot_icall_1_10(method_bind_36, Object.GetPtr(this), multiplier);
        }

        private IntPtr method_bind_37 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_shadow_gradient_length");

        public float get_shadow_gradient_length()
        {
            return NativeCalls.godot_icall_0_11(method_bind_37, Object.GetPtr(this));
        }

        private IntPtr method_bind_38 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_shadow_filter");

        public void set_shadow_filter(int filter)
        {
            NativeCalls.godot_icall_1_0(method_bind_38, Object.GetPtr(this), filter);
        }

        private IntPtr method_bind_39 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_shadow_filter");

        public int get_shadow_filter()
        {
            return NativeCalls.godot_icall_0_1(method_bind_39, Object.GetPtr(this));
        }

        private IntPtr method_bind_40 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_shadow_color");
