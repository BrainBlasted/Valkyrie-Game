...
namespace GodotEngine
{
    public static class PhysicsServer
    {
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_1_335(method_bind_0, ptr, type);
            return new RID(ret);
        }
        ...
        {
            NativeCalls.godot_icall_2_342(method_bind_1, ptr, RID.GetPtr(shape), data);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_2, ptr, RID.GetPtr(shape));
        }

        private static IntPtr method_bind_3 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "shape_get_data");

        public static object shape_get_data(RID shape)
        {
            return NativeCalls.godot_icall_1_344(method_bind_3, ptr, RID.GetPtr(shape));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_0_122(method_bind_4, ptr);
            return new RID(ret);
        }
        ...
        {
            NativeCalls.godot_icall_2_345(method_bind_5, ptr, RID.GetPtr(space), active);
        }
        ...
        {
            return NativeCalls.godot_icall_1_346(method_bind_6, ptr, RID.GetPtr(space));
        }
        ...
        {
            NativeCalls.godot_icall_3_347(method_bind_7, ptr, RID.GetPtr(space), param, value);
        }
        ...
        {
            return NativeCalls.godot_icall_2_348(method_bind_8, ptr, RID.GetPtr(space), param);
        }
        ...
        {
            return NativeCalls.godot_icall_1_379(method_bind_9, ptr, RID.GetPtr(space));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_0_122(method_bind_10, ptr);
            return new RID(ret);
        }
        ...
        {
            NativeCalls.godot_icall_2_350(method_bind_11, ptr, RID.GetPtr(area), RID.GetPtr(space));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_1_351(method_bind_12, ptr, RID.GetPtr(area));
            return new RID(ret);
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_13, ptr, RID.GetPtr(area), mode);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_14, ptr, RID.GetPtr(area));
        }
        ...
        public static void area_add_shape(RID area, RID shape, Nullable<Transform> transform = null)
        {
            ...
            NativeCalls.godot_icall_3_380(method_bind_15, ptr, RID.GetPtr(area), RID.GetPtr(shape), ref transform_in);
        }
        ...
        {
            NativeCalls.godot_icall_3_354(method_bind_16, ptr, RID.GetPtr(area), shape_idx, RID.GetPtr(shape));
        }
        ...
        {
            NativeCalls.godot_icall_3_381(method_bind_17, ptr, RID.GetPtr(area), shape_idx, ref transform);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_18, ptr, RID.GetPtr(area));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_357(method_bind_19, ptr, RID.GetPtr(area), shape_idx);
            return new RID(ret);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_2_382(method_bind_20, ptr, RID.GetPtr(area), shape_idx);
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_21, ptr, RID.GetPtr(area), shape_idx);
        }
        ...
        {
            NativeCalls.godot_icall_1_359(method_bind_22, ptr, RID.GetPtr(area));
        }

        private static IntPtr method_bind_23 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "area_set_collision_layer");

        public static void area_set_collision_layer(RID area, int layer)
        {
            NativeCalls.godot_icall_2_352(method_bind_23, ptr, RID.GetPtr(area), layer);
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_24, ptr, RID.GetPtr(area), mask);
        }
        ...
        {
            NativeCalls.godot_icall_2_383(method_bind_26, ptr, RID.GetPtr(area), ref transform);
        }

        private static IntPtr method_bind_27 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "area_get_param");

        public static object area_get_param(RID area, int param)
        {
            return NativeCalls.godot_icall_2_362(method_bind_27, ptr, RID.GetPtr(area), param);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_384(method_bind_28, ptr, RID.GetPtr(area));
            return (Transform)ret;
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_29, ptr, RID.GetPtr(area), id);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_30, ptr, RID.GetPtr(area));
        }
        ...
        {
            NativeCalls.godot_icall_3_364(method_bind_31, ptr, RID.GetPtr(area), Object.GetPtr(receiver), method);
        }
        ...
        {
            NativeCalls.godot_icall_2_345(method_bind_32, ptr, RID.GetPtr(area), enable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_346(method_bind_33, ptr, RID.GetPtr(area));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_365(method_bind_34, ptr, mode, init_sleeping);
            return new RID(ret);
        }
        ...
        {
            NativeCalls.godot_icall_2_350(method_bind_35, ptr, RID.GetPtr(body), RID.GetPtr(space));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_1_351(method_bind_36, ptr, RID.GetPtr(body));
            return new RID(ret);
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_37, ptr, RID.GetPtr(body), mode);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_38, ptr, RID.GetPtr(body));
        }

        private static IntPtr method_bind_39 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_collision_layer");

        public static void body_set_collision_layer(RID body, int layer)
        {
            NativeCalls.godot_icall_2_352(method_bind_39, ptr, RID.GetPtr(body), layer);
        }

        private static IntPtr method_bind_40 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_get_collision_layer");

        public static int body_get_collision_layer(RID body)
        {
            return NativeCalls.godot_icall_1_343(method_bind_40, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_41, ptr, RID.GetPtr(body), mask);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_42, ptr, RID.GetPtr(body));
        }
        ...
        {
            Transform transform_in = transform.HasValue ? transform.Value : new Transform();
            NativeCalls.godot_icall_3_380(method_bind_43, ptr, RID.GetPtr(body), RID.GetPtr(shape), ref transform_in);
        }
        ...
        {
            NativeCalls.godot_icall_3_354(method_bind_44, ptr, RID.GetPtr(body), shape_idx, RID.GetPtr(shape));
        }
        ...
        {
            NativeCalls.godot_icall_3_381(method_bind_45, ptr, RID.GetPtr(body), shape_idx, ref transform);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_46, ptr, RID.GetPtr(body));
        }
        ...
        {
            IntPtr ret = NativeCalls.godot_icall_2_357(method_bind_47, ptr, RID.GetPtr(body), shape_idx);
            return new RID(ret);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_2_382(method_bind_48, ptr, RID.GetPtr(body), shape_idx);
            return (Transform)ret;
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_49, ptr, RID.GetPtr(body), shape_idx);
        }
        ...
        {
            NativeCalls.godot_icall_1_359(method_bind_50, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_51, ptr, RID.GetPtr(body), id);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_52, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_345(method_bind_53, ptr, RID.GetPtr(body), enable);
        }
        ...
        {
            return NativeCalls.godot_icall_1_346(method_bind_54, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_3_347(method_bind_55, ptr, RID.GetPtr(body), param, value);
        }
        ...
        {
            return NativeCalls.godot_icall_2_348(method_bind_56, ptr, RID.GetPtr(body), param);
        }
        ...
        public static object body_get_state(RID body, int state)
        {
            return NativeCalls.godot_icall_2_362(method_bind_58, ptr, RID.GetPtr(body), state);
        }
        ...
        {
            NativeCalls.godot_icall_3_385(method_bind_59, ptr, RID.GetPtr(body), ref pos, ref impulse);
        }

        private static IntPtr method_bind_60 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_apply_torque_impulse");

        public static void body_apply_torque_impulse(RID body, Vector3 impulse)
        {
            NativeCalls.godot_icall_2_386(method_bind_60, ptr, RID.GetPtr(body), ref impulse);
        }

        private static IntPtr method_bind_61 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_axis_velocity");

        public static void body_set_axis_velocity(RID body, Vector3 axis_velocity)
        {
            NativeCalls.godot_icall_2_386(method_bind_61, ptr, RID.GetPtr(body), ref axis_velocity);
        }

        private static IntPtr method_bind_62 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_axis_lock");

        public static void body_set_axis_lock(RID body, int axis)
        {
            NativeCalls.godot_icall_2_352(method_bind_62, ptr, RID.GetPtr(body), axis);
        }

        private static IntPtr method_bind_63 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_get_axis_lock");

        public static int body_get_axis_lock(RID body)
        {
            return NativeCalls.godot_icall_1_343(method_bind_63, ptr, RID.GetPtr(body));
        }
        ...
        {
            NativeCalls.godot_icall_2_350(method_bind_64, ptr, RID.GetPtr(body), RID.GetPtr(excepted_body));
        }
        ...
        {
            NativeCalls.godot_icall_2_350(method_bind_65, ptr, RID.GetPtr(body), RID.GetPtr(excepted_body));
        }
        ...
        {
            NativeCalls.godot_icall_2_352(method_bind_66, ptr, RID.GetPtr(body), amount);
        }
        ...
        {
            return NativeCalls.godot_icall_1_343(method_bind_67, ptr, RID.GetPtr(body));
        }

        private static IntPtr method_bind_68 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_omit_force_integration");

        public static void body_set_omit_force_integration(RID body, bool enable)
        {
            NativeCalls.godot_icall_2_345(method_bind_68, ptr, RID.GetPtr(body), enable);
        }

        private static IntPtr method_bind_69 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_is_omitting_force_integration");

        public static bool body_is_omitting_force_integration(RID body)
        {
            return NativeCalls.godot_icall_1_346(method_bind_69, ptr, RID.GetPtr(body));
        }

        private static IntPtr method_bind_70 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_force_integration_callback");

        public static void body_set_force_integration_callback(RID body, Object receiver, string method, object userdata = null)
        {
            NativeCalls.godot_icall_4_368(method_bind_70, ptr, RID.GetPtr(body), Object.GetPtr(receiver), method, userdata);
        }

        private static IntPtr method_bind_71 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_set_ray_pickable");

        public static void body_set_ray_pickable(RID body, bool enable)
        {
            NativeCalls.godot_icall_2_345(method_bind_71, ptr, RID.GetPtr(body), enable);
        }

        private static IntPtr method_bind_72 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "body_is_ray_pickable");

        public static bool body_is_ray_pickable(RID body)
        {
            return NativeCalls.godot_icall_1_346(method_bind_72, ptr, RID.GetPtr(body));
        }

        private static IntPtr method_bind_73 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_create_pin");

        public static RID joint_create_pin(RID body_A, Vector3 local_A, RID body_B, Vector3 local_B)
        {
            IntPtr ret = NativeCalls.godot_icall_4_387(method_bind_73, ptr, RID.GetPtr(body_A), ref local_A, RID.GetPtr(body_B), ref local_B);
            return new RID(ret);
        }

        private static IntPtr method_bind_74 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "pin_joint_set_param");

        public static void pin_joint_set_param(RID joint, int param, float value)
        {
            NativeCalls.godot_icall_3_347(method_bind_74, ptr, RID.GetPtr(joint), param, value);
        }

        private static IntPtr method_bind_75 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "pin_joint_get_param");

        public static float pin_joint_get_param(RID joint, int param)
        {
            return NativeCalls.godot_icall_2_348(method_bind_75, ptr, RID.GetPtr(joint), param);
        }

        private static IntPtr method_bind_76 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "pin_joint_set_local_a");

        public static void pin_joint_set_local_a(RID joint, Vector3 local_A)
        {
            NativeCalls.godot_icall_2_386(method_bind_76, ptr, RID.GetPtr(joint), ref local_A);
        }

        private static IntPtr method_bind_77 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "pin_joint_get_local_a");

        public static Vector3 pin_joint_get_local_a(RID joint)
        {
            object ret = NativeCalls.godot_icall_1_388(method_bind_77, ptr, RID.GetPtr(joint));
            return (Vector3)ret;
        }

        private static IntPtr method_bind_78 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "pin_joint_set_local_b");

        public static void pin_joint_set_local_b(RID joint, Vector3 local_B)
        {
            NativeCalls.godot_icall_2_386(method_bind_78, ptr, RID.GetPtr(joint), ref local_B);
        }

        private static IntPtr method_bind_79 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "pin_joint_get_local_b");

        public static Vector3 pin_joint_get_local_b(RID joint)
        {
            object ret = NativeCalls.godot_icall_1_388(method_bind_79, ptr, RID.GetPtr(joint));
            return (Vector3)ret;
        }

        private static IntPtr method_bind_80 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_create_hinge");

        public static RID joint_create_hinge(RID body_A, Transform hinge_A, RID body_B, Transform hinge_B)
        {
            IntPtr ret = NativeCalls.godot_icall_4_389(method_bind_80, ptr, RID.GetPtr(body_A), ref hinge_A, RID.GetPtr(body_B), ref hinge_B);
            return new RID(ret);
        }

        private static IntPtr method_bind_81 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "hinge_joint_set_param");

        public static void hinge_joint_set_param(RID joint, int param, float value)
        {
            NativeCalls.godot_icall_3_347(method_bind_81, ptr, RID.GetPtr(joint), param, value);
        }

        private static IntPtr method_bind_82 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "hinge_joint_get_param");

        public static float hinge_joint_get_param(RID joint, int param)
        {
            return NativeCalls.godot_icall_2_348(method_bind_82, ptr, RID.GetPtr(joint), param);
        }

        private static IntPtr method_bind_83 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "hinge_joint_set_flag");

        public static void hinge_joint_set_flag(RID joint, int flag, bool enabled)
        {
            NativeCalls.godot_icall_3_356(method_bind_83, ptr, RID.GetPtr(joint), flag, enabled);
        }

        private static IntPtr method_bind_84 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "hinge_joint_get_flag");

        public static bool hinge_joint_get_flag(RID joint, int flag)
        {
            return NativeCalls.godot_icall_2_390(method_bind_84, ptr, RID.GetPtr(joint), flag);
        }

        private static IntPtr method_bind_85 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_create_slider");

        public static RID joint_create_slider(RID body_A, Transform local_ref_A, RID body_B, Transform local_ref_B)
        {
            IntPtr ret = NativeCalls.godot_icall_4_389(method_bind_85, ptr, RID.GetPtr(body_A), ref local_ref_A, RID.GetPtr(body_B), ref local_ref_B);
            return new RID(ret);
        }

        private static IntPtr method_bind_86 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "slider_joint_set_param");

        public static void slider_joint_set_param(RID joint, int param, float value)
        {
            NativeCalls.godot_icall_3_347(method_bind_86, ptr, RID.GetPtr(joint), param, value);
        }

        private static IntPtr method_bind_87 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "slider_joint_get_param");

        public static float slider_joint_get_param(RID joint, int param)
        {
            return NativeCalls.godot_icall_2_348(method_bind_87, ptr, RID.GetPtr(joint), param);
        }

        private static IntPtr method_bind_88 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_create_cone_twist");

        public static RID joint_create_cone_twist(RID body_A, Transform local_ref_A, RID body_B, Transform local_ref_B)
        {
            IntPtr ret = NativeCalls.godot_icall_4_389(method_bind_88, ptr, RID.GetPtr(body_A), ref local_ref_A, RID.GetPtr(body_B), ref local_ref_B);
            return new RID(ret);
        }

        private static IntPtr method_bind_89 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "cone_twist_joint_set_param");

        public static void cone_twist_joint_set_param(RID joint, int param, float value)
        {
            NativeCalls.godot_icall_3_347(method_bind_89, ptr, RID.GetPtr(joint), param, value);
        }

        private static IntPtr method_bind_90 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "cone_twist_joint_get_param");

        public static float cone_twist_joint_get_param(RID joint, int param)
        {
            return NativeCalls.godot_icall_2_348(method_bind_90, ptr, RID.GetPtr(joint), param);
        }

        private static IntPtr method_bind_91 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_get_type");

        public static int joint_get_type(RID joint)
        {
            return NativeCalls.godot_icall_1_343(method_bind_91, ptr, RID.GetPtr(joint));
        }

        private static IntPtr method_bind_92 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_set_solver_priority");

        public static void joint_set_solver_priority(RID joint, int priority)
        {
            NativeCalls.godot_icall_2_352(method_bind_92, ptr, RID.GetPtr(joint), priority);
        }

        private static IntPtr method_bind_93 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_get_solver_priority");

        public static int joint_get_solver_priority(RID joint)
        {
            return NativeCalls.godot_icall_1_343(method_bind_93, ptr, RID.GetPtr(joint));
        }

        private static IntPtr method_bind_94 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "joint_create_generic_6dof");

        public static RID joint_create_generic_6dof(RID body_A, Transform local_ref_A, RID body_B, Transform local_ref_B)
        {
            IntPtr ret = NativeCalls.godot_icall_4_389(method_bind_94, ptr, RID.GetPtr(body_A), ref local_ref_A, RID.GetPtr(body_B), ref local_ref_B);
            return new RID(ret);
        }

        private static IntPtr method_bind_95 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "generic_6dof_joint_set_param");

        public static void generic_6dof_joint_set_param(RID joint, int axis, int param, float value)
        {
            NativeCalls.godot_icall_4_391(method_bind_95, ptr, RID.GetPtr(joint), axis, param, value);
        }

        private static IntPtr method_bind_96 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "generic_6dof_joint_get_param");

        public static float generic_6dof_joint_get_param(RID joint, int axis, int param)
        {
            return NativeCalls.godot_icall_3_392(method_bind_96, ptr, RID.GetPtr(joint), axis, param);
        }

        private static IntPtr method_bind_97 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "generic_6dof_joint_set_flag");

        public static void generic_6dof_joint_set_flag(RID joint, int axis, int flag, bool enable)
        {
            NativeCalls.godot_icall_4_393(method_bind_97, ptr, RID.GetPtr(joint), axis, flag, enable);
        }

        private static IntPtr method_bind_98 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "generic_6dof_joint_get_flag");

        public static bool generic_6dof_joint_get_flag(RID joint, int axis, int flag)
        {
            return NativeCalls.godot_icall_3_394(method_bind_98, ptr, RID.GetPtr(joint), axis, flag);
        }

        private static IntPtr method_bind_99 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "free_rid");

        public static void free_rid(RID rid)
        {
            NativeCalls.godot_icall_1_359(method_bind_99, ptr, RID.GetPtr(rid));
        }

        private static IntPtr method_bind_100 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_active");

        public static void set_active(bool active)
        {
            NativeCalls.godot_icall_1_7(method_bind_100, ptr, active);
        }

        private static IntPtr method_bind_101 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_process_info");

        public static int get_process_info(int process_info)
        {
            return NativeCalls.godot_icall_1_5(method_bind_101, ptr, process_info);
        }
    }
}
