...
namespace GodotEngine
{
    ...
    public class Directory : Reference
    {
        ...
        public int get_current_drive()
        {
            return NativeCalls.godot_icall_0_1(method_bind_7, Object.GetPtr(this));
        }

        private IntPtr method_bind_8 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "change_dir");
        ...
        private IntPtr method_bind_10 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "make_dir");
        ...
        private IntPtr method_bind_15 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "copy");
