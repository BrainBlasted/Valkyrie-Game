...
namespace GodotEngine
{
    ...
    public class SegmentShape2D : Shape2D
    {
        ...
        public SegmentShape2D() : this(false)
        {
            if (ptr == IntPtr.Zero)
        ...
        {
            NativeCalls.godot_icall_1_37(method_bind_0, Object.GetPtr(this), ref a);
        }
        ...
        {
            NativeCalls.godot_icall_1_37(method_bind_2, Object.GetPtr(this), ref b);
        }
