...
namespace GodotEngine
{
    ...
    {
        public const int NOTIFICATION_WM_MOUSE_ENTER = 2;
        public const int NOTIFICATION_WM_MOUSE_EXIT = 3;
        public const int NOTIFICATION_WM_FOCUS_IN = 4;
        public const int NOTIFICATION_WM_FOCUS_OUT = 5;
        public const int NOTIFICATION_WM_QUIT_REQUEST = 6;
