...
namespace GodotEngine
{
    ...
    public static class Input
    {
        ...
        public const int MOUSE_MODE_CONFINED = 3;
        ...
        {
            return NativeCalls.godot_icall_1_22(method_bind_0, ptr, scancode);
        }
        ...
        {
            return NativeCalls.godot_icall_1_22(method_bind_1, ptr, button);
        }
        ...
        {
            return NativeCalls.godot_icall_2_25(method_bind_2, ptr, device, button);
        }
        ...
        {
            return NativeCalls.godot_icall_1_22(method_bind_8, ptr, device);
        }
        ...
        {
            return NativeCalls.godot_icall_2_48(method_bind_9, ptr, device, axis);
        }
        ...
        {
            object ret = NativeCalls.godot_icall_1_178(method_bind_13, ptr, device);
            return (Vector2)ret;
        }
        ...
        {
            return NativeCalls.godot_icall_1_6(method_bind_14, ptr, device);
        }
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_20, ptr, device);
        }

        private static IntPtr method_bind_21 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_gravity");

        public static Vector3 get_gravity()
        {
            object ret = NativeCalls.godot_icall_0_4(method_bind_21, ptr);
            return (Vector3)ret;
        }

        private static IntPtr method_bind_22 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_accelerometer");
        ...
        {
            object ret = NativeCalls.godot_icall_0_4(method_bind_22, ptr);
            return (Vector3)ret;
        }

        private static IntPtr method_bind_23 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_magnetometer");
        ...
        {
            object ret = NativeCalls.godot_icall_0_4(method_bind_23, ptr);
            return (Vector3)ret;
        }

        private static IntPtr method_bind_24 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_gyroscope");
        ...
        {
            object ret = NativeCalls.godot_icall_0_4(method_bind_24, ptr);
            return (Vector3)ret;
        }

        private static IntPtr method_bind_25 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_last_mouse_speed");

        /// <summary>
        /// Returns the mouse speed for the last time the cursor was moved, and this until the next frame where the mouse moves. This means that even if the mouse is not moving, this function will still return the value of the last motion.
        /// </summary>
        public static Vector2 get_last_mouse_speed()
        {
            object ret = NativeCalls.godot_icall_0_9(method_bind_25, ptr);
            return (Vector2)ret;
        }

        private static IntPtr method_bind_26 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_mouse_button_mask");
        ...
        {
            return NativeCalls.godot_icall_0_1(method_bind_26, ptr);
        }

        private static IntPtr method_bind_27 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_mouse_mode");
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_27, ptr, mode);
        }

        private static IntPtr method_bind_28 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_mouse_mode");
        ...
        {
            return NativeCalls.godot_icall_0_1(method_bind_28, ptr);
        }

        private static IntPtr method_bind_29 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "warp_mouse_pos");
        ...
        {
            NativeCalls.godot_icall_1_37(method_bind_29, ptr, ref to);
        }

        private static IntPtr method_bind_30 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "action_press");
