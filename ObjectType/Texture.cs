...
namespace GodotEngine
{
    ...
    public class Texture : Resource
    {
        ...
        private IntPtr method_bind_3 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "has_alpha");
        ...
        private IntPtr method_bind_4 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "set_flags");
        ...
        {
            NativeCalls.godot_icall_1_0(method_bind_4, Object.GetPtr(this), flags);
        }

        private IntPtr method_bind_5 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "get_flags");
        ...
        private IntPtr method_bind_6 = NativeCalls.godot_icall_TypeDB_get_method(nativeName, "draw");
        ...
        public void draw(RID canvas_item, Vector2 pos, Nullable<Color> modulate = null, bool transpose = false, Texture normal_map = null)
        {
            ...
            NativeCalls.godot_icall_5_458(method_bind_6, Object.GetPtr(this), RID.GetPtr(canvas_item), ref pos, ref modulate_in, transpose, Object.GetPtr(normal_map));
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            NativeCalls.godot_icall_6_459(method_bind_7, Object.GetPtr(this), RID.GetPtr(canvas_item), ref rect, tile, ref modulate_in, transpose, Object.GetPtr(normal_map));
        }
        ...
        {
            Color modulate_in = modulate.HasValue ? modulate.Value : new Color(1, 1, 1, 1);
            NativeCalls.godot_icall_7_460(method_bind_8, Object.GetPtr(this), RID.GetPtr(canvas_item), ref rect, ref src_rect, ref modulate_in, transpose, Object.GetPtr(normal_map), clip_uv);
        }
        ...
        {
            return NativeCalls.godot_icall_0_461(method_bind_9, Object.GetPtr(this));
        }
    }
}
